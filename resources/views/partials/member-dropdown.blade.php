<div class="user-account-settingss">
    <ul class="us-links text-center">
        ...
        <li><a href="{{ route('frontend.members.profile', auth()->user()->id) }}" title="My Profile" class="main-dropdown-btn"><i class="fa fa-dashboard"></i> My Profile</a></li>
        <li><a href="{{ route('member.dashboard.home') }}" title="Member Dashboard" class="main-dropdown-btn"><i class="fa fa-dashboard"></i> Member Dashboard</a></li>
